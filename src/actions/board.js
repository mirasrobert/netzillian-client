...
export const renameBoard = (boardId, formData) => async (dispatch) => {
  try {
    const res = await axios.patch(
      process.env.REACT_APP_API_URL + `/api/boards/rename/${boardId}`,
      formData,
      config
    )
...
export const renameList = (listId, formData) => async (dispatch) => {
  try {
    const res = await axios.patch(
      `${process.env.REACT_APP_API_URL}/api/lists/rename/${listId}`,
      formData,
      config
    )
...
export const archiveList = (listId, archive) => async (dispatch) => {
  try {
    const res = await axios.patch(
      `${process.env.REACT_APP_API_URL}/api/lists/archive/${archive}/${listId}`
    )
...
export const getCard = (id) => async (dispatch) => {
  try {
    const res = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/cards/${id}`
    )
...
export const editCard = (cardId, formData) => async (dispatch) => {
  try {
    const res = await axios.patch(
      `${process.env.REACT_APP_API_URL}/api/cards/edit/${cardId}`,
      formData,
      config
    )
...
export const moveCard = (cardId, formData) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `${process.env.REACT_APP_API_URL}/api/cards/move/${cardId}`,
      body,
      config
    )
...
export const archiveCard = (cardId, archive) => async (dispatch) => {
  try {
    const res = await axios.patch(
      `${process.env.REACT_APP_API_URL}/api/cards/archive/${archive}/${cardId}`
    )
...
export const deleteCard = (listId, cardId) => async (dispatch) => {
  try {
    const res = await axios.delete(
      `${process.env.REACT_APP_API_URL}/api/cards/${listId}/${cardId}`
    )
...
export const getActivity = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/boards/activity/${boardId}`
    )
...
export const addMember = (userId) => async (dispatch) => {
  try {
    const res = await axios.put(
      `${process.env.REACT_APP_API_URL}/api/boards/addMember/${userId}`
    )
...
export const moveList = (listId, formData) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `${process.env.REACT_APP_API_URL}/api/lists/move/${listId}`,
      body,
      config
    )
...
export const addCardMember = (formData) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      `${process.env.REACT_APP_API_URL}/api/cards/addMember/${add}/${cardId}/${userId}`
    )
...
export const addChecklistItem = (cardId, formData) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      `${process.env.REACT_APP_API_URL}/api/checklists/${cardId}`,
      body,
      config
    )
...
export const editChecklistItem =
  (cardId, itemId, formData) => async (dispatch) => {
    try {
      ...
      const res = await axios.patch(
        `${process.env.REACT_APP_API_URL}/api/checklists/${cardId}/${itemId}`,
        body,
        config
      )
...
export const completeChecklistItem = (formData) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `${process.env.REACT_APP_API_URL}/api/checklists/${cardId}/${complete}/${itemId}`
    )
